...
public class Box2DNativeWrapper {
	...
	public native int createCircle(final float pX, final float PY, final float pRadius, final float pDensity, final float pRestitution, final float pFriction, final boolean pHandleContacts);

	public native int createBox(final float pX, final float pY, final float pWidth, final float pHeight, final float pDensity, final float pRestitution, final float pFriction, final boolean pHandleContacts);
